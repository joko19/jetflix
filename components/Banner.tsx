...
function Banner({ netflixOriginals }: Props) {
  ...
  return (
    <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
      ...
      <h1 className="text-2xl md:text-4xl lg:text-7x font-bold">
      ...
      <div className="flex space-x-3">
          ...
          <button className="bannerButton bg-[gray]/70">More Info <BsInfoCircle className="h-4 w-4 md:h-8 md:w-8"/></button>
      </div>
    </div>
  );
}
